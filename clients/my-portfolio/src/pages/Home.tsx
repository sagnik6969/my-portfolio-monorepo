...
export default function Home() {
  ...
  const handleDownloadResume = () => {
    downloadFile(resumePDF, "Sagnik_Jana_Resume.pdf");
  };
  ...
  const projects = [
    {
      ...
      description:
        "A full-stack task scheduling application with lazy loading and authentication",
      technologies: [
        "Vue.js",
        "PHP",
        "Laravel",
    ...
    },
    {
      ...
      title: "Job Portal",
      description:
        "A comprehensive job portal with search, posting, and application tracking",
